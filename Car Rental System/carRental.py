...
class carRent:
    ...
    def requestDay(self, day , cars):
        if cars > Data().getCar():
            ...
            print("You will be charged ",day * 20,"$ for each day per car and 15$ for every extra day")
            print("We hope that you enjoy our service!")
    ...
    def requestWeek(self, week , cars):
        if cars > Data().getCar():
            ...
            print("You will be charged ",week * 50,"$ for each week per car and 20$ for every extra day")
            print("We hope that you enjoy our service!")