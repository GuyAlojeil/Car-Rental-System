...
def permission():
    ...
    try:
        ...
        if password in name:
            ...
            print("Wrong password , please enter a valid one !")
            sleep(2)
            permission()
    ...
    try:
        ...
        if choice == 1:
            ...
            for _ in range (0,numberOfCars):
                ...
                returningDate = input("Enter the date for retuning the car [dd/mm/yy hour]: ")
                carNumber = int(input("Enter the car(s) number : "))
                while carNumber not in Data().showCar():
                    carNumber = int(input("Please enter another car : "))
                else:
                    Data(carNumber = carNumber).deleteCar()
                    Data(ID , name , phoneNumber , numberOfCars , sellingDate , returningDate , carNumber).addClient()
                    carRent().requestHour(hour, numberOfCars)
                    input()
            main()
        elif choice == 2:
            ID = Data().createID()
            print("The ID of the customer is ", ID)
            numberOfCars = int((input("Enter the number of car(s) : ")))
            day = int(input("Enter the number of day(s) : "))
            for _ in range (0,numberOfCars):
                name = input("\nEnter the client name : ")
                phoneNumber = input("Enter the phone number of the client name : ")
                sellingDate = input("Enter the date of today [dd/mm/yy hour]: ")
                ...
                while carNumber not in Data().showCar():
                    ...
                    Data(carNumber = carNumber).deleteCar()
                    Data(ID , name , phoneNumber , numberOfCars , sellingDate , returningDate , carNumber).addClient()
                    carRent().requestDay(day, numberOfCars)
                    input()
            main()           
        elif choice == 3:
            ID = Data().createID()
            print("The ID of the customer is ", ID)
            numberOfCars = int((input("Enter the number of car(s) : ")))
            week = int(input("Enter the number of week(s) : "))
            for _ in range (0,numberOfCars):
                name = input("\nEnter the client name : ")
                phoneNumber = input("Enter the phone number of the client name : ")
                sellingDate = input("Enter the date of today [dd/mm/yy hour]: ")
                ...
                while carNumber not in Data().showCar():
                    ...
                    Data(carNumber = carNumber).deleteCar()
                    Data(ID , name , phoneNumber , numberOfCars , sellingDate , returningDate , carNumber).addClient()
                    carRent().requestWeek(week, numberOfCars)
                    input()
            main()
